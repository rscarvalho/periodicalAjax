...
this.ajaxOptions=ajaxOptions;this.frequency=frequency;this.isRunning=false;this.url=url;this.callInterval=-1;if(window.console!==undefined)
this.console=window.console;else
this.console=function(){};this.request=null;};PeriodicalChecker.prototype.start=function(){var self=this;this.callInterval=setInterval(function(){self.runOnce();},this.frequency);};PeriodicalChecker.prototype.runOnce=function(){if(this.isRunning){return;}
